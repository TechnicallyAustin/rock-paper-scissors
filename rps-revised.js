  ...
  const playGame = () => {
    const createButtons = () => {
      ...
      const createRockButton = () => {
        const rockButton = gameDiv.appendChild(
      ...
      const createPaperButton = () => {
        const paperButton = gameDiv.appendChild(
          document.createElement("button")
        );
        paperButton.setAttribute("id", "paper-button");
        paperButton.setAttribute("value", "paper");
        const paperImage = paperButton.appendChild(
    ...
    const endOfGame = (playerChoices, roundsPlayed) => {
      ...
      playButton.addEventListener("click", () => {
        ...
        const removebuttons = () => {
          const rockButtonSelector = document.getElementById("rock-button");
          const paperButtonSelector = document.getElementById("paper-button");
          const scissorsButtonSelector =
            document.getElementById("scissor-button");
          rockButtonSelector.remove();
          paperButtonSelector.remove();
          scissorsButtonSelector.remove();
        };
        removebuttons();
        createButtons();
      });
